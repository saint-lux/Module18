...
---
### Running Dashboard
1. Start dashboard from terminal

    ![alt=""](Images/start-dashboard.png)
2. Enter Transaction Record - Sender | Receiver | Amount
    ![alt=""](Images/Trans-1.png)
    ![alt=""](Images/Trans-3.png)

3. Expand PyChain Ledger for better visibilty
    ![alt=""](Images/Trans-2.png)

4. Check PyChain Ledger

    ![alt=""](Images/Validate-1.png)
    ![alt=""](Images/Validate-2.png)

5. Inspect Transaction In the block with `Block Inspector`

    ![alt=""](Images/block-inspector.png)
